...
LoadingBar.prototype.createLoadingAnim = function(e) {
    ...
    this.card_1 = e.add.sprite(a - 140, r, t).setScale(s, i).setFrame(0),
        this.card_2 = e.add.sprite(a - 70, r, t).setScale(s, i).setFrame(1),
        this.card_3 = e.add.sprite(a + 0, r, t).setScale(s, i).setFrame(2),
        this.card_4 = e.add.sprite(a + 70, r, t).setScale(s, i).setFrame(0),
        this.card_5 = e.add.sprite(a + 140, r, t).setScale(s, i).setFrame(1),
        this.tween_1 = e.add.tween(d(this.card_1, 0)),
        this.tween_2 = e.add.tween(d(this.card_2, 50)),
        this.tween_3 = e.add.tween(d(this.card_3, 100)),
        this.tween_4 = e.add.tween(d(this.card_4, 150)),
        this.tween_5 = e.add.tween(d(this.card_5, 200))
};
